...
#Installation NFS
docker run --name rancher-nfs-server-$VERSION_RANCHER --restart=always -d --privileged -v /var/docker/volume/rancher-nfs:/share -v /var/docker/volume/rancher-nfs/exports:/etc/exports -eSHARED_DIRECTORY=/share -p 111:111/tcp -p 111:111/udp -p 2049:2049/tcp -p 2049:2049/udp lixter/nfs-server:latest
